package com.sbip.ch04.service;

import com.sbip.ch04.model.Course;
import com.sbip.ch04.repository.CourseRepository;
...
public class DefaultCourseService implements CourseService {
    ...
    public Course createCourse(Course course) {
        ...
        try {
             ...
             */
            course1 = createCoursesTimer.recordCallable(() -> courseRepository.save(course));
        }catch (Exception ex){
